...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> RegisterCompany([FromBody] RegisterCompanyRequest request)
    {
        ...
        var newTenant = new Tenant
        {
            ...
            CommercialRegistration = request.CrNumber,
        ...
        var subscription = new Subscription
        {
            ...
            PlanNameAr = request.PlanType == SubscriptionPlanType.Starter ? "باقة البداية" :
                         request.PlanType == SubscriptionPlanType.Professional ? "باقة الشركات المتقدمة" : "باقة المؤسسات",
            BillingCycle = request.BillingCycle,
            StartDate = DateTime.UtcNow,
            ExpiryDate = request.BillingCycle == BillingCycle.Yearly ? DateTime.UtcNow.AddYears(1) : DateTime.UtcNow.AddMonths(1),
...
public class RegisterCompanyRequest
{
    ...
    public string Password { get; set; } = string.Empty;
    public SubscriptionPlanType PlanType { get; set; } = SubscriptionPlanType.Professional;
